<?php
/**
 * index.php is the first page our od survey_sez application it's based on demo_list_pager.php along with demo_view_pager.php provides a sample web application
 *
...
$config->metaDescription = 'Seattle Central\'s ITC250 Class Survey are made with pure PHP! ' . $config->metaDescription;
